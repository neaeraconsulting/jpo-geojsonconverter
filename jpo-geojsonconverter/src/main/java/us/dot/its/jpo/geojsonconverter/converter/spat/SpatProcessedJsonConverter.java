...
// J2735IntersectionState intersectionState =
// spatPayload.getSpat().getIntersectionStateList().getIntersectionStatelist().get(0);
...
// Integer moyTimestamp = intersectionState.getMoy(); // Minute of the year, elapsed minutes since January in UTC
// // time
...
// intersectionState.getEnabledLanes() != null ? intersectionState.getEnabledLanes().getEnabledLaneList()
// : null);
...
// for (J2735MovementEvent incomingMovementEvent : signalGroupState.getState_time_speed()
