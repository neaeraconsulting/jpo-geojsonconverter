...
// Topology topology =
// SpatTopology.build(kafkaTopicOdeSpatJson, kafkaTopicProcessedSpat, spatJsonValidator);
// try (TopologyTestDriver driver = new TopologyTestDriver(topology)) {
// TestInputTopic<Void, String> inputOdeSpatJsonTopic =
// driver.createInputTopic(kafkaTopicOdeSpatJson, Serdes.Void().serializer(),
// Serdes.String().serializer());
// TestOutputTopic<RsuIntersectionKey, ProcessedSpat> outputTopic = driver.createOutputTopic(
// kafkaTopicProcessedSpat, JsonSerdes.RsuIntersectionKey().deserializer(),
