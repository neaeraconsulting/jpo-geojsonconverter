...
public class ProcessedBsmDeserializerTest {
    ...
    public void testProcessedBsmJsonDeserializer() {
        try (ProcessedBsmDeserializer<Point> serializer = new ProcessedBsmDeserializer<Point>(Point.class)) {
            ...
            assertEquals(TransmissionState.UNAVAILABLE, props.getTransmission());
            ...
            assertEquals(TractionControlStatus.UNAVAILABLE, brakes.getTraction());
            assertEquals(AntiLockBrakeStatus.UNAVAILABLE, brakes.getAbs());
            assertEquals(StabilityControlStatus.UNAVAILABLE, brakes.getScs());
            assertEquals(BrakeBoostApplied.UNAVAILABLE, brakes.getBrakeBoost());
            assertEquals(AuxiliaryBrakeStatus.UNAVAILABLE, brakes.getAuxBrakes());
